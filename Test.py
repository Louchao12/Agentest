...
with open('E:\\pydemo\\Agent\\maxvalue.text', 'r') as file_agent_res:
    ...
    print(max_vector)
with open('E:\\pydemo\\Agent\\test.txt', 'a') as file_agent_res,\
        open('E:\\pydemo\\Agent\\maxvalue.text', 'r') as f:
    lines = f.readlines()
